<template>
  ...
  export default {
    ...
    methods:{
      getCenter(){
        axios.get('/data_analysis/'+this.project_id+'/dashboard/get_center_d2')
          .then(response => {
      ...
      getChartData(){
        ...
        axios.post('/data_analysis/'+this.project_id+'/dashboard/dashboard2', {
  ...
  google.charts.load('current', {'packages':['treemap']});
    ...
    function drawChart1(dataChart1) {
      ...
      var options = {
        title: "Brands of FCMP sell from this store",
        bar: {groupWidth: "95%"},
