      ...
      <!-- <div class="col-md-2">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card p-0 card-outline card-warning">
                    <div class="card-body p-0" style="overflow: hidden;">
                        <div id="columnchart_reasoneProb"></div>
                        <span style="font-size: smaller;margin-left: 20px;">Base: {{ this.baseChart9 }}</span>
                    </div>
                </div>    
            </div>
...
export default {
  ...
  methods:{
    ...
    getChartData(){
      ...
      axios.post('/dashboard_infoc/'+this.project_id+'/child03', {
        ...
        this.dataChart8 = response.data[14];
        this.baseChart8 = response.data[15];        

        this.dataChart9 = response.data[16];
        this.baseChart9 = response.data[17];        

        this.dataChart10 = response.data[18];
        this.baseChart10 = response.data[19];
        ...
        google.charts.setOnLoadCallback(drawChartReasonSpont(this.dataChart8));
        google.charts.setOnLoadCallback(drawChartReasonProb(this.dataChart9));
        google.charts.setOnLoadCallback(drawChartReasonAll(this.dataChart10));
...
//     }
  ...
  //***column chart */
  function drawChartReasonSpont(dataChart){
    var data = google.visualization.arrayToDataTable(dataChart);
    ...
    var view = new google.visualization.DataView(data);
      ...
      var options = {
        title: "Reason for consuming MPV-Spont",
        // width: 600,
        // height: 400,
        fontSize: 10,
        bar: {groupWidth: "50%"},
      ...
      var chart = new google.visualization.ColumnChart(document.getElementById('columnchart_reasoneSpont'));
      chart.draw(view, options);
  }

  //***column chart */
  function drawChartReasonProb(dataChart){
    var data = google.visualization.arrayToDataTable(dataChart);
    ...
    var view = new google.visualization.DataView(data);
      ...
      var options = {
        title: "Reason for consuming MPV-Prob",
        // width: 600,
        // height: 400,
        fontSize: 10,
        bar: {groupWidth: "50%"},
      ...
      var chart = new google.visualization.ColumnChart(document.getElementById('columnchart_reasoneProb'));
      chart.draw(view, options);
  }

  //***column chart */
  function drawChartReasonAll(dataChart){
    var data = google.visualization.arrayToDataTable(dataChart);
    ...
    var view = new google.visualization.DataView(data);
      ...
      var options = {
        title: "Reason for consuming MPV-All",
        // width: 600,
        // height: 400,
        fontSize: 10,
        bar: {groupWidth: "50%"},
      ...
      var chart = new google.visualization.ColumnChart(document.getElementById('columnchart_reasoneAll'));
      chart.draw(view, options);
  }
