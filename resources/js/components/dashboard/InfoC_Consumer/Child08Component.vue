        ...
        <!-- <div class="col-md-2">
          ...
          <div class="row">
              ...
              <div class="col-md-2">
                ...
                <div class="info-box card-outline card-danger" style="margin-bottom: 6px;">
              ...
              <div class="info-box card-outline card-danger mb-1">
                <!-- <span class="info-box-icon bg-info"><i class="far fa-envelope"></i></span> -->
              ...
              <div class="col-md-4">
                  <div class="card pl-3 pr-3 card-outline card-danger">
                      <div class="card-body p-0" style="overflow: hidden;">
