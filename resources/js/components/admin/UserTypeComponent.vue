<template>
    <div>
        <div class="row mb-2">
            <div class="text-end">
                <button @click="addUserType" type="button" class="btn btn-sm btn-success">add</button>
            </div>           
        </div> 
        ...
        <table class="table table-sm table-bordered">
            ...
            <tbody>
                <tr v-for="(row,index) in allUserType" :key="index">
                    <td> {{index+1}}</td>
                    <td> {{row.user_type}}</td>
                    <td>
        ...
        <div class="modal fade" id="interviewerModal" >
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <!-- <form class="container mt-3" ref="addUserType" @submit.prevent="saveUsers()"> -->
                    <!-- Modal Header -->
    ...
    export default {
        ...
        methods:{
            initdata() {
                ...
                axios.get('/user_type/get_user_type')
