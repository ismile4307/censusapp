<template>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Variable List</div>
...
<script>
    export default {
        ...
        methods:{
            getTableData(){
                axios.get('/settings/'+this.project_id+'/set_variables/get_table_data')
                .then(response => {
            ...
            removeVariable(id){
                axios.get('/settings/'+this.project_id+'/'+id+'/set_variables/remove_variable')
                .then(response => {
                    this.TableData = response.data;
                    // console.log(response.data);
                });
