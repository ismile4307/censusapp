...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <respondentpanel-component :project_id={{$project->id}}></respondentpanel-component>
            {{-- <div class="card">
...
function activeMenu() {
    ...
    document.getElementById("resp_panel_list").classList.add("menu-open");
    document.getElementById("resp_panel_link").classList.add("active");
    document.getElementById("panel_selection_link").classList.add("active");
